...
public interface MemoryService {
     ...
     */
    List<PropositionEntity> recall(String userId, String queryText, List<String> topics);
     ...
     * @return 命题列表
     */
    List<PropositionEntity> findRecent(String userId, Instant since);
