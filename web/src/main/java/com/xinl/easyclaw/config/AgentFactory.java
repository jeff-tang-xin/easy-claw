...
public class AgentFactory {
     ...
     * 任务闭环、输出规范），<b>不含任何人格设定</b>。
     * <p>
     * 人格（我是谁、我的目标、我的行事风格）由角色层负责，见
     * {@link com.xinl.easyclaw.role.RolePromptComposer}，在本段之后拼接。
     * 这样切分的原因：基座对所有工作区一致且很少变动，人格则按角色/场景切换；
     * 两者混写会导致角色人设与基座自称互相打架（例如角色叫 AI-CLAW，基座却
     * 自称"Easy-Claw AI 智能助手"）。
     * <p>
     * 新增内容前请判断归属：与工具、流程、平台约束有关 → 放这里；与身份、
     * 语气、价值取向有关 → 放角色。
     */
    public String defaultSystemPrompt() {
        return """
                ...
                - 代码：编写、重构、优化、解释代码
                - 文件：读写文件、管理目录、搜索文件（所有文件操作限制在当前工作区内）
                - 检索：搜索信息、获取网页内容
